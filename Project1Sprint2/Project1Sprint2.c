        ...
        while(Input_State==0){
            ...
            if (ReturnVal == INVALID){
                ...
                printf("Please enter one of the following commands: Allocate Memory [Number of Bytes]\n"
                       ...
                       "                                            Display Memory (optional -o option to specify offset instead of hex address) [Memory Address as an integer offset starting from 0 if -o option was chosen or as a hex value] (optional number of memory words to write)\n"
